...
public class LoadMeshModel {
    ...
    public static ModelData loadModel(String fileName) {
        AIScene scene = Assimp.aiImportFile(Config.OUTPUT_FOLDER + "/models/entities/" + fileName + ".obj",
        ...
        if (scene == null) {
            System.err.println("the imported file does not contain any scene. " + Config.OUTPUT_FOLDER + "/models/entities/" + fileName + ".obj");
            //System.exit(0);
        }
